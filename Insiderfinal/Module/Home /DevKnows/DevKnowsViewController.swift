...
class DevKnowsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    // Theme Colors from GetStarted
    private let getStartedBlue = UIColor(red: 0.40, green: 0.55, blue: 0.85, alpha: 1.0)
    private let lightBackgroundBlue = UIColor(red: 0.93, green: 0.95, blue: 0.98, alpha: 1.0)
    ...
    private func setupUI() {
        ...
        inputContainer.layer.borderColor = UIColor.systemGray6.cgColor
    ...
    private func fetchGroqResponse(for prompt: String) {
        ...
        // Build explicit prompt with Article Context
...
// MARK: - Custom Chat Cell (Blue Theme)
class ChatBubbleCell: UITableViewCell {
    ...
    func configure(with message: ChatMessage) {
        ...
        if message.isUser {
            ...
            bubbleView.backgroundColor = lightBackgroundBlue

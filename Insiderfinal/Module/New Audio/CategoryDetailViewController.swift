...
//        guard let toolkitName = toolkitName else {
//            filteredBriefs = store.topChoices
//            return
//        }
//        
//        filteredBriefs = store.getFilteredBriefs(for: toolkitName)
//    }
//    
...
//        countLabel.text = "\(filteredBriefs.count) episodes"
...
//        guard !filteredBriefs.isEmpty else { return }
//        
